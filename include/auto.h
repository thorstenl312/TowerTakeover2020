...
void Auton(){
  if(Red1){
    ...
    arm.stop(hold);
    arm.resetRotation();
    splineRight(-25, 11.15, 200, 30); 
    positiveYForward(45,55,30);
    rollerSpin(100);
    negativeYBackward(23,70,30);
    turnRightO(122.5,30);
    roller.spin(forward,100,pct);
    accelerate(100,30);
    wait(350,msec);
...
void Skills(){
  ...
  task ar(armDown2);
  positiveXBackward(-2.2,50,30);

  //Get First Line of Cubes
  turnRightO(-0.3,70,40);
  rollerSpin(100);
