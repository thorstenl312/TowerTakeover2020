...
void Skills(){
  ...
  negativeYBackward(114.4,50,60);
  turnRightO(94,30,30);
  rollerSpin(60);
  positiveXForward(29.5,55,30);
  stopDrive(hold);
  wait(150,msec);
