...
void Auton(){
  if(Red1){
    ...
    arm.stop(hold);
    arm.resetRotation();
    splineLeft(30, -9.5, 200, 30); 
    positiveYForward(46,60,30);
    rollerSpin(100);
    negativeYBackward(22.2,70,30);
    rollerSpin(0);
    turnLeftO9(-126,30);
    roller.spin(forward,100,pct);
    accelerate(100,30);
...
void Skills(){
  ...
  wait(300,msec);
  task e(rollOut45);
  arm.rotateTo(500,degrees,95,velocityUnits::pct,true);
  turnRightO(22,30);
  ...
  task ip(armDown);
  positiveYBackward(47,50,30);

  //Get more cubes
  turnLeftO(50,30,70);
  task::stop(ip);
  positiveXForward(35,80,30);
  turnRightO9(95,30,30);
  positiveXForward(50,50,30);

  //Place cube in tower
  turnLeftO9(0,30,40);
  positiveYForward(44,50,30);
  task p(rollOut45);
  arm.rotateTo(500,degrees,95,velocityUnits::pct,true);
  turnRightO(22,30);
  RollerL.rotateFor(-600,degrees,60, velocityUnits::pct,false);
